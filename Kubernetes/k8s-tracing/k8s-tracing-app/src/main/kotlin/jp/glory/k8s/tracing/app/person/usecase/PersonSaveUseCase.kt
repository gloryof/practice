...
import jp.glory.k8s.tracing.app.person.domain.PersonRegisterEventSpec
import jp.glory.k8s.tracing.app.person.domain.PersonSaveEventRepository
import jp.glory.k8s.tracing.app.person.domain.PersonUpdateEventSpec
