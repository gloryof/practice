package jp.glory.k8s.tracing.app.base.usecase

import jp.glory.k8s.tracing.app.base.domain.SpecErrorDetail
import jp.glory.k8s.tracing.app.base.domain.SpecErrors
