package jp.glory.k8s.mesh.app.person.store

import com.fasterxml.jackson.databind.ObjectMapper
import jp.glory.k8s.mesh.app.person.domain.PersonId
import jp.glory.k8s.mesh.app.person.domain.PersonRegisterEvent
import jp.glory.k8s.mesh.app.person.domain.PersonSaveEventRepository
import jp.glory.k8s.mesh.app.person.domain.PersonUpdateEvent
