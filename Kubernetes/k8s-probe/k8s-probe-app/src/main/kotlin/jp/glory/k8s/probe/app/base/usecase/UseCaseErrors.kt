package jp.glory.k8s.probe.app.base.usecase

import jp.glory.k8s.probe.app.base.domain.SpecErrorDetail
import jp.glory.k8s.probe.app.base.domain.SpecErrors
