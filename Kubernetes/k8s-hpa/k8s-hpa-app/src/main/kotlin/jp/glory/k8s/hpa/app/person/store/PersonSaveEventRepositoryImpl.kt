package jp.glory.k8s.hpa.app.person.store

import com.fasterxml.jackson.databind.ObjectMapper
import jp.glory.k8s.hpa.app.person.domain.PersonId
import jp.glory.k8s.hpa.app.person.domain.PersonRegisterEvent
import jp.glory.k8s.hpa.app.person.domain.PersonSaveEventRepository
import jp.glory.k8s.hpa.app.person.domain.PersonUpdateEvent
