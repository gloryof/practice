package jp.glory.ktor.practice.auth.domain.model

import jp.glory.ktor.practice.auth.domain.event.InputPassword
import jp.glory.ktor.practice.auth.domain.event.InputUserId
import jp.glory.ktor.practice.auth.domain.event.UserAuthenticateEvent
